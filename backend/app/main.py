...
# Model configuration - Support 4 models
MODEL_PATHS = {
    "model_a": "models/tes.keras",
    "model_b": "models/conx.keras",
    "model_c": "models/casc.keras",
    "model_d": "models/modf.keras",
}
...
#         logger.warning("Application starting without models - predictions will fail")
#         return
...
#     logger.info("=" * 50)
#     if loaded_count == len(available_models):
#         logger.info(f"✅ All {loaded_count} models loaded successfully - API ready")
#     elif loaded_count > 0:
#         logger.warning(
#             f"⚠️ Partial success: {loaded_count}/{len(available_models)} models loaded"
#         )
#     else:
...
async def startup_event():
    ...
    if missing_models:
        ...
        fallback_path = "models/bckup.keras"
...
async def root():
    ...
    return {
        ...
        "models": {
            ...
            "model_d": "Model D loaded" if "model_d" in models else "Not loaded",
        },
...
async def health_check():
    ...
    return {
        ...
        "models_loaded": {
            ...
            "model_d": "model_d" in models and models["model_d"] is not None,
        },
